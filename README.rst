...
* Более удачная аутентификация. Давать ответ что такого логина нет, или пользователь
и вовсе забанен.
